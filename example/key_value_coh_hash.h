...
__host__ __inline__ __device__ T_KEY        GET_KEY_POS(T_HASH_TABLE k)                                                  { return ((k) & KEY_TYPE_MASK); }
__host__ __inline__ __device__ T_VALUE      GET_KEY_ATTACH_ID(T_HASH_TABLE k)                                            { return ((k) >> (KEY_TYPE_BITS)) & ATTACH_ID_TYPE_MASK; }
__host__ __inline__ __device__ T_HASH_TABLE PACK_KEY_POS(T_KEY p)                                                        { return ((p) & KEY_TYPE_MASK); }
__host__ __inline__ __device__ T_HASH_TABLE PACK_KEY_POS_AND_ATTACH_ID_AND_AGE(T_KEY p, T_ATTACH_ID i, T_AGE a)          { return T_HASH_TABLE(((T_HASH_TABLE(a) << (ATTACH_ID_TYPE_BITS + KEY_TYPE_BITS))) + ((T_HASH_TABLE(i) & ATTACH_ID_TYPE_MASK) << (KEY_TYPE_BITS)) + T_HASH_TABLE(p & KEY_TYPE_MASK)); }
__host__ __inline__ __device__ T_HASH_TABLE PACK_KEY_POS_AND_ATTACH_ID_AND_MAX_AGE(T_KEY p, T_ATTACH_ID i, T_MAX_AGE m)  { return T_HASH_TABLE(((T_HASH_TABLE(m) << (ATTACH_ID_TYPE_BITS + KEY_TYPE_BITS))) + ((T_HASH_TABLE(i) & ATTACH_ID_TYPE_MASK) << (KEY_TYPE_BITS)) + T_HASH_TABLE(p & KEY_TYPE_MASK)); }
